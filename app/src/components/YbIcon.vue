...
const paths: Record<IconName, string> = {
  ...
  gear:
    '<circle cx="12" cy="12" r="3.2"/><path d="M12 2.9v2.3M12 18.8v2.3M5.6 5.6l1.6 1.6M16.8 16.8l1.6 1.6M2.9 12h2.3M18.8 12h2.3M5.6 18.4l1.6-1.6M16.8 7.2l1.6-1.6"/>',
  spinner:
  ...
  // 团子剪影：空态占位用，比 🍡 更贴合形象本体
  dumpling:
    '<path d="M12 6.6c-3.7 0-6.6 3.6-6.6 7.6 0 3.7 2.9 6.3 6.6 6.3s6.6-2.6 6.6-6.3c0-4-2.9-7.6-6.6-7.6z"/><path d="M12 6.6V4.4"/><circle cx="12" cy="3" r="1.4"/>',
  mic:
