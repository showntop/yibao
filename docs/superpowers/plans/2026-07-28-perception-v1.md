...
- [ ] **Step 3: 实现最小 store 和 key provider**
...
- [ ] **Step 3: 挂载 store/sensors/cleanup**
...
- [ ] **Step 2: 增加 TypeScript DTO 与一次性接口**
